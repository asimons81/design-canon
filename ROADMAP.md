...
- [x] Publication allowlist, lockfile verification, and npm provenance configuration
- [x] Security, contribution, configuration, and release documentation
...
- [ ] Local browser capture adapter
- [ ] Structured visual-review JSON contract
- [ ] Viewport and interaction-state matrix
...
- [ ] Accessibility checks backed by browser evidence
...
Design Canon is credibly better than a monolithic prompt bundle when it can demonstrate:
